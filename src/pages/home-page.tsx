      ...
      <section className="relative px-5 md:px-10 pt-[180px] h-[80vh] md:h-[75vh]">
        ...
        <div className="">
          ...
          <p className="mt-7 text-[#34115a]">
            ...
            ta'lim imkoniyatlarini topishda yordam <br /> beramiz.
            Mutaxassislarning tavsiyalari va talabalarning haqiqiy sharhlari
            bilan ta'lim safaringizni <br /> osonlashtiramiz.
          </p>
        </div>
      </section>
      <Cards />
